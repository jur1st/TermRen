...
**Authors:** [Boris Cherny](https://www.anthropic.com/team/boris-cherny)
...
1. [Customize your setup](#1-customize-your-setup)
2. [Give Claude more tools](#2-give-claude-more-tools)
3. [Try common workflows](#3-try-common-workflows)
4. [Optimize your workflow](#4-optimize-your-workflow)
5. [Use headless mode to automate your infra](#5-use-headless-mode-to-automate-your-infra)
6. [Uplevel with multi-Claude workflows](#6-uplevel-with-multi-claude-workflows)
